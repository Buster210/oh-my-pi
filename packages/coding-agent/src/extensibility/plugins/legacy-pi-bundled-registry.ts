...
import * as bundledPiCodingAgentToolsSqliteReaderProtocol from "@oh-my-pi/pi-coding-agent/tools/sqlite-reader-protocol";
import * as bundledPiCodingAgentToolsSqliteReaderWorker from "@oh-my-pi/pi-coding-agent/tools/sqlite-reader-worker";
...
export const BUNDLED_PI_REGISTRY: Readonly<Record<string, Readonly<Record<string, unknown>>>> = {
	...
	"@oh-my-pi/pi-coding-agent/tools/search-tool-bm25": bundledPiCodingAgentToolsSearchToolBm25 as unknown as Readonly<
		Record<string, unknown>
	>,
	"@oh-my-pi/pi-coding-agent/tools/sqlite-reader-protocol":
		bundledPiCodingAgentToolsSqliteReaderProtocol as unknown as Readonly<Record<string, unknown>>,
	"@oh-my-pi/pi-coding-agent/tools/sqlite-reader-worker":
		bundledPiCodingAgentToolsSqliteReaderWorker as unknown as Readonly<Record<string, unknown>>,
